...
import com.trkj.hr.exception.CustomError;
import com.trkj.hr.exception.CustomErrorType;
...
public class JwtAuthService {
    ...
    public String login(String username, String password) throws CustomError {
        ...
        Yuangongbiao loginUser = (Yuangongbiao) authentication.getPrincipal();
        log.debug(loginUser.toString());
        //存入redis中
        redisUtil.setCacheObject("login"+loginUser.getYbh(),loginUser);
        System.out.println(redisUtil.getCacheObject("login"+loginUser.getYbh()));
        return jwtTokenUtil.generateToken(loginUser.getUsername(),loginUser.getYbh()+"");
    }
